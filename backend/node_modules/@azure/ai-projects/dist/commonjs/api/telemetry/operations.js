...
exports.createTelemetryOperations = createTelemetryOperations;
 ...
 */
function createTelemetryOperations(connectionClient) {
    const state = {
    ...
    return {
        ...
        async getApplicationInsightsConnectionString() {
            if (!state._connectionString) {
                ...
                if (!connectionName) {
                    throw new core_rest_pipeline_1.RestError("No Application Insights connection found.", {
