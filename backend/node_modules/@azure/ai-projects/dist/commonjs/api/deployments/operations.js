...
function _listSend(context, options = { requestOptions: {} }) {
    const path = (0, urlTemplate_js_1.expandUrlTemplate)("/deployments{?api-version,modelPublisher,modelName,deploymentType}", {
...
async function _listDeserialize(result) {
    ...
    return (0, models_js_1._pagedDeploymentDeserializer)(result.body);
}
...
function _getSend(context, name, options = { requestOptions: {} }) {
    const path = (0, urlTemplate_js_1.expandUrlTemplate)("/deployments/{name}{?api-version}", {
        name: name,
        "api-version": context.apiVersion,
    }, {
        allowReserved: options?.requestOptions?.skipUrlEncoding,
...
async function _getDeserialize(result) {
    ...
    return (0, models_js_1.deploymentUnionDeserializer)(result.body);
}
