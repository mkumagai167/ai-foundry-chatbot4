...
function _createOrUpdateSend(context, name, version, index, options = { requestOptions: {} }) {
    ...
    return context.path(path).patch({
        ...
        body: (0, models_js_1.indexUnionSerializer)(index),
    });
}
...
async function createOrUpdate(context, name, version, index, options = { requestOptions: {} }) {
