...
exports._getAzureOpenAIClient = _getAzureOpenAIClient;
 ...
 */
async function _getAzureOpenAIClient(context, connections, options) {
        ...
        if (connection.credentials.type === "ApiKey") {
            ...
            return new openai_1.AzureOpenAI({
                azureADTokenProvider: async () => {
                    const getAccessToken = (0, identity_1.getBearerTokenProvider)(tokenCredential, "https://cognitiveservices.azure.com/.default");
