...
exports.agentV1ErrorDeserializer = agentV1ErrorDeserializer;
exports.agentErrorDetailDeserializer = agentErrorDetailDeserializer;
...
function functionDefinitionArraySerializer(result) {
    return result.map((item) => {
        return functionDefinitionSerializer(item);
    });
}
function functionDefinitionArrayDeserializer(result) {
    return result.map((item) => {
...
function agentV1ErrorDeserializer(item) {
    return {
        error: agentErrorDetailDeserializer(item["error"]),
    };
}
function agentErrorDetailDeserializer(item) {
    return {
