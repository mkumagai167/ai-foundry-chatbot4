...
import { cancelRun, submitToolOutputsToRun, updateRun, getRun, listRuns, createRun, createRunAndPoll, } from "../../api/runs/operations.js";
...
function _getRuns(context) {
    return {
        ...
        createAndPoll: (threadId, assistantId, options) => createRunAndPoll(context, threadId, assistantId, options),
